...
import com.kumarbusem.githubsearch.adapters.RepositoryAdapter;
...
import com.kumarbusem.githubsearch.rest.api_calls.GetDefaultRepo;
...
public class MainActivity extends BaseActivity implements Callback<RepoObject>, View.OnClickListener {
    ...
    private FloatingActionButton filterImage;

    private Search.OnQueryTextListener listener = new Search.OnQueryTextListener() {
        @Override
...
//            });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setLogoIcon(R.drawable.ic_search_black_24dp);
